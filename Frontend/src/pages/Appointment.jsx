...
const Appointment = () => {
  ...
  const getAvailableSlots = async () => {
    ...
    for(let i=0;i<7;i++){
      ...
      currentDate.setDate(today.getDate()+i) // for future seven days
  ...
  return docInfo &&(
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        {docInfo ? (
          <div>
            <img className='bg-primary w-full sm:max-w-72 rounded-lg' src={docInfo.image || '/default-image.png'} alt="Doctor" />
          </div>
        ) : (
